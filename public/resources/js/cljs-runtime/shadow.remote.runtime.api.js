...
var shadow$remote$runtime$api$IRuntime$add_extension$dyn_13326 = (function (runtime,key,spec){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_13326(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_13329 = (function (runtime,key){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_13329(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_13332 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_13332(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13336 = (function (runtime,input,callback){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_13336(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_13341 = (function (runtime,code){
var x__5350__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_13341(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__13311,callback){
var map__13312 = p__13311;
var map__13312__$1 = cljs.core.__destructure_map(map__13312);
var input = map__13312__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13312__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__13312__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
