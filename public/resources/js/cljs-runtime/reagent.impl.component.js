...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22477 = c;
var G__22477__$1 = (((G__22477 == null))?null:G__22477.prototype);
if((G__22477__$1 == null)){
return null;
} else {
return G__22477__$1.reagentRender;
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__22481 = c;
var G__22481__$1 = (((G__22481 == null))?null:G__22481.prototype);
if((G__22481__$1 == null)){
return null;
} else {
return G__22481__$1.render;
}
})() == null)))));
});
...
return (function() { 
var G__22667__delegate = function (args){
...
G__22667.cljs$lang$applyTo = (function (arglist__22669){
...
var or__5002__auto__ = (function (){var G__22509 = c;
var G__22509__$1 = (((G__22509 == null))?null:G__22509.constructor);
if((G__22509__$1 == null)){
return null;
} else {
return G__22509__$1.displayName;
}
})();
...
var _STAR_current_component_STAR__orig_val__22518 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22519 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22519);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22518);
}});
...
var c = this;
var G__22556_22680 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__22556_22680 == null)){
} else {
reagent.ratom.dispose_BANG_(G__22556_22680);
}
...
var renders_22682 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_22683 = cljs.core.first(cljs.core.vals(renders_22682));
...
if((cljs.core.count(renders_22682) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_22682))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_22683)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_22683], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__22607 = o;
reagent.impl.component.goog$module$goog$object.set(G__22607,cljs.core.name(k),v);
...
var _STAR_current_component_STAR__orig_val__22642 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__22643 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__22643);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__22642);
}});
...
var vec__22649 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22649,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22649,(1),null);
...
var G__22654 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__22654 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__22654);
}
});
}),[]);
