...
reagent.impl.input.input_node_set_value = (function reagent$impl$input$input_node_set_value(node,rendered_value,dom_value,component,p__22664){
var map__22666 = p__22664;
var map__22666__$1 = cljs.core.__destructure_map(map__22666);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__22666__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var _STAR_force_set_dom_value_STAR__orig_val__22672 = reagent.impl.input._STAR_force_set_dom_value_STAR_;
var _STAR_force_set_dom_value_STAR__temp_val__22673 = true;
(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__temp_val__22673);
...
}finally {(reagent.impl.input._STAR_force_set_dom_value_STAR_ = _STAR_force_set_dom_value_STAR__orig_val__22672);
}}));
} else {
...
(jsprops.onChange = (function (p1__22679_SHARP_){
return reagent.impl.input.input_handle_change(this$,on_change,p1__22679_SHARP_);
}));
