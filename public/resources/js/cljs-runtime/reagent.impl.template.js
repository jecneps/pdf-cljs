...
var G__22708 = o;
reagent.impl.template.goog$module$goog$object.set(G__22708,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null, v)));
...
var G__22728 = o;
reagent.impl.template.goog$module$goog$object.set(G__22728,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
G__22823.cljs$lang$applyTo = (function (arglist__22825){
...
var G__22737 = props;
var G__22737__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22737,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__22737);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22737__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,(function (){var or__5002__auto__ = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__22739 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__22739,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__22739;
}
})(),id_class);
...
var G__22741 = (cljs.core.count(argv) - first_child);
switch (G__22741) {
case (0):
...
var vec__22749 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22749,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22749,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22749,(2),null);
...
var temp__5808__auto___22851 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22851 == null)){
} else {
var key_22854 = temp__5808__auto___22851;
(jsprops.key = key_22854);
}
...
var temp__5808__auto___22855 = reagent.impl.util.react_key_from_vec(v);
if((temp__5808__auto___22855 == null)){
} else {
var key_22856 = temp__5808__auto___22855;
(jsprops.key = key_22856);
}
...
var temp__5808__auto___22863 = reagent.impl.util.react_key_from_vec(argv);
if((temp__5808__auto___22863 == null)){
} else {
var key_22867 = temp__5808__auto___22863;
(jsprops.key = key_22867);
}
...
var temp__5808__auto___22881 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22881 == null)){
} else {
var key_22882 = temp__5808__auto___22881;
(jsprops.key = key_22882);
}
...
var temp__5808__auto___22884 = reagent.impl.util.get_react_key(cljs.core.meta(argv));
if((temp__5808__auto___22884 == null)){
} else {
var key_22885 = temp__5808__auto___22884;
(jsprops.key = key_22885);
}
...
return cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__22766_SHARP_){
return reagent.impl.protocols.as_element(compiler,p1__22766_SHARP_);
}),s));
});
...
var ctx = ({});
var vec__22768 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx,compiler);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22768,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__22768,(1),null);
...
break;
default:
var G__22905 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
...
*/
reagent.impl.template.t_reagent$impl$template22803 = (function (opts,id,fn_to_element,parse_fn,meta22804){
this.opts = opts;
this.id = id;
this.fn_to_element = fn_to_element;
this.parse_fn = parse_fn;
this.meta22804 = meta22804;
this.cljs$lang$protocol_mask$partition0$ = 393216;
this.cljs$lang$protocol_mask$partition1$ = 0;
});
(reagent.impl.template.t_reagent$impl$template22803.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_22805,meta22804__$1){
var self__ = this;
var _22805__$1 = this;
return (new reagent.impl.template.t_reagent$impl$template22803(self__.opts,self__.id,self__.fn_to_element,self__.parse_fn,meta22804__$1));
}));

(reagent.impl.template.t_reagent$impl$template22803.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_22805){
var self__ = this;
var _22805__$1 = this;
return self__.meta22804;
}));

(reagent.impl.template.t_reagent$impl$template22803.prototype.reagent$impl$protocols$Compiler$ = cljs.core.PROTOCOL_SENTINEL);

(reagent.impl.template.t_reagent$impl$template22803.prototype.reagent$impl$protocols$Compiler$get_id$arity$1 = (function (this$){
var self__ = this;
var this$__$1 = this;
return self__.id;
}));

(reagent.impl.template.t_reagent$impl$template22803.prototype.reagent$impl$protocols$Compiler$parse_tag$arity$3 = (function (this$,tag_name,tag_value){
var self__ = this;
var this$__$1 = this;
...
(reagent.impl.template.t_reagent$impl$template22803.prototype.reagent$impl$protocols$Compiler$as_element$arity$2 = (function (this$,x){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.as_element(this$__$1,x,self__.fn_to_element);
}));

(reagent.impl.template.t_reagent$impl$template22803.prototype.reagent$impl$protocols$Compiler$make_element$arity$5 = (function (this$,argv,component,jsprops,first_child){
var self__ = this;
var this$__$1 = this;
return reagent.impl.template.make_element(this$__$1,argv,component,jsprops,first_child);
}));

(reagent.impl.template.t_reagent$impl$template22803.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"opts","opts",1795607228,null),new cljs.core.Symbol(null,"id","id",252129435,null),new cljs.core.Symbol(null,"fn-to-element","fn-to-element",-1764467095,null),new cljs.core.Symbol(null,"parse-fn","parse-fn",-836029424,null),new cljs.core.Symbol(null,"meta22804","meta22804",1408916458,null)], null);
}));

(reagent.impl.template.t_reagent$impl$template22803.cljs$lang$type = true);

(reagent.impl.template.t_reagent$impl$template22803.cljs$lang$ctorStr = "reagent.impl.template/t_reagent$impl$template22803");

(reagent.impl.template.t_reagent$impl$template22803.cljs$lang$ctorPrWriter = (function (this__5287__auto__,writer__5288__auto__,opt__5289__auto__){
return cljs.core._write(writer__5288__auto__,"reagent.impl.template/t_reagent$impl$template22803");
}));

/**
 * Positional factory function for reagent.impl.template/t_reagent$impl$template22803.
 */
reagent.impl.template.__GT_t_reagent$impl$template22803 = (function reagent$impl$template$__GT_t_reagent$impl$template22803(opts,id,fn_to_element,parse_fn,meta22804){
return (new reagent.impl.template.t_reagent$impl$template22803(opts,id,fn_to_element,parse_fn,meta22804));
});
...
return (new reagent.impl.template.t_reagent$impl$template22803(opts,id,fn_to_element,parse_fn,cljs.core.PersistentArrayMap.EMPTY));
});
